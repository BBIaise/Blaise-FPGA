...
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports led0_v]
...
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports led1_v]
...
set_property MARK_DEBUG true [get_nets {FSM_onehot_current_state_reg_n_0_[0]}]
set_property MARK_DEBUG true [get_nets {FSM_onehot_current_state[1]_i_1_n_0}]
set_property MARK_DEBUG true [get_nets {FSM_onehot_current_state[3]_i_2_n_0}]
set_property MARK_DEBUG true [get_nets {FSM_onehot_current_state_reg_n_0_[1]}]
set_property MARK_DEBUG true [get_nets {FSM_onehot_current_state_reg_n_0_[2]}]
set_property MARK_DEBUG true [get_nets {FSM_onehot_current_state_reg_n_0_[3]}]
set_property MARK_DEBUG true [get_nets u_counter_cycle/led_blink]
